...
function describeRouterRoute(router, metaData) {
    ...
    if (!router.stack) {
        throw new Error(
            'router.stack was null, either the item that swaggerize & describe was called on is not an express app/router or you have called describe before adding at least one route'
        );
    }
