...
function initialise(app, options, callback) {
    ...
    validation.initialise(callback);
}
...
function compile() {
    ...
    if (!state.router) {
        return new Error("Router was null, either your app is not an express app, you have not yet called initialise, or you have called compile before adding at least one route");
    }
...
function callValidate() {
    return validation.validate(json());
}
...
function describeAppRoute(metaData) {
    ...
    if (!state.router) {
        return new Error("Router was null, either your app is not an express app, you have not yet called initialise, or you have called describeAppRoute before adding at least one route");
    }
    if (!metaData) {
