 ...
 * This is done using the [ajv](https://www.npmjs.com/package/ajv) validator against the [official JSON schema](https://www.npmjs.com/package/swagger-schema-official).
 * @throws {Error} Throws an exception if called before `compile` or `initialise`.
