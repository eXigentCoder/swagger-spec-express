...
function applyNameDeletion(options) {
    if (options.deleteNameFromCommon) {
      ...
      * @name AddCommonItemOptions Optional set of values which controls how the the provided item will be added to common.
      ...
      * @prop deleteNameFromCommon - Controls if, after adding the item to common, it should remove the name in order to pass the Swagger schema validation.
      */